...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         mysqli_query($con, "UPDATE `user_form` SET password = '$confirm_pass' WHERE id = '$user_id'") 
         or die('query failed');
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="file" name="update_image" accept="image/jpg, image/jpeg, image/png, image/svg" class="box">
         </div>
         <div class="inputBox">
